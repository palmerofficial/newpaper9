...
var ExactMetrics = function() {
        ...
        function y(e, t, n) {
            ...
            var l = ['event_category', 'event_label', 'value', ],
                i = c(n, l);
            i.send_to = exactmetrics_frontend.ua;
            __gtagTracker(e, t, i)
        };
        ...
        function p() {
            if (exactmetrics_frontend.hash_tracking === 'true' && f != window.location.hash && (exactmetrics_frontend.ua || exactmetrics_frontend.v4_id)) {
